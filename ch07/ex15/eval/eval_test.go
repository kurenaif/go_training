...
func TestEval(t *testing.T) {
	tests := []struct {
		...
		{"~(x)~", Env{"x": 1}, "1"},
		{"|(x,y)|", Env{"x": 3, "y": 4}, "5"},
		{"^(x,y,z)^", Env{"x": 1, "y": 2, "z": 3}, "3"},
		{"^(x,y,z)^", Env{"x": 3, "y": 2, "z": 1}, "3"},
		{"^(x,y,z)^", Env{"x": 3, "y": 1, "z": 2}, "3"},
		{"~(x,y,z)~", Env{"x": 1, "y": 2, "z": 3}, "1"},
		{"~(x,y,z)~", Env{"x": 3, "y": 2, "z": 1}, "1"},
		{"~(x,y,z)~", Env{"x": 3, "y": 1, "z": 2}, "1"},
		{"^(x+y, x-y)^", Env{"x": 3, "y": 4}, "7"},
		{"~(x+y, x-y)~", Env{"x": 3, "y": 4}, "-1"},
	}
	var prevExpr string

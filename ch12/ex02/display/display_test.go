...
func Test(t *testing.T) {
	...
	// ----------------------------------------------------------------------------------------------------
	// ex12.1 array
	ma := make(map[[3]int]string)
	ma[[3]int{1, 2, 3}] = "Hello"
	ma[[3]int{3, 4, 5}] = "World"
	Display("ma", ma)
	// Output:
	// Display ma (map[[3]int]]string):
	// ma[[1 2 3]] = "Hello"
	// ma[[3 5 6]] = "World"
	...
	mb := make(map[T]string)
	mb[T{"Hello", 3}] = "hello"
	mb[T{"World", 5}] = "world"
	Display("mb", mb)
	// Output:
	// Display mb (map[display.T]string):
	// mb[{name:"Hello" age:3}] = "hello"
	// mb[{name:"World" age:5}] = "world"
	...
	mc := make(map[U]bool)
	ts := [2]T{{"Hello", 3}, {"World", 5}}
	v := V{5, ts}
	u := U{"kurenaif", v}
	mc[u] = true
	Display("mc", mc)
	// Output:
	// Display mc (map[display.U]bool):
	// mc[{name:"kurenaif" v:{age:5 arr:[{name:"Hello" age:3} {name:"World" age:5}]}}] = true
